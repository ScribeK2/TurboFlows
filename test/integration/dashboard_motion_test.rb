...
# it ~360ms later and restarted them mid-flight. Measured 2026-09-12 in Chromium:
# no layout shift at all, so the replayed animations were the whole effect. This
# keeps both causes out.
