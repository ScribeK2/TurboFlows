...
- The builder outline (2026-09) has no migration and no cutover hazard: a tab open across the deploy shows the old flat list until it reloads, and its writes are the same writes.
