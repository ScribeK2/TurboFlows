...
| `.badge--warning` "Members can't see this" | A featured workflow a team's members don't get: unpublished, filed out of reach, or visible but past the first 8 — shown on the team page with the reason, not counted toward the 8 | Pill: an exceptional state |
